...
client.on("message", msg => {
  ...
  if (kufur.some(word => msg.content.toLowerCase().includes(word)) ) {
    if (!msg.member.hasPermission("ADMINISTRATOR")) {
      msg.delete()
       msg.reply("Bu sunucuda küfürler **Rego Craft** tarafından engellenmektedir! Küfür etmene izin vermeyeceğim!").then(message => message.delete(3000));
    }
}
    }
});
...
client.on("message", msg => {
  ...
  if (linkEngel[msg.guild.id].linkEngel === 'kapali') return;
    if (linkEngel[msg.guild.id].linkEngel=== 'acik') {
      const lınk = [".com", "discord.gg", "https", ".net", "www."];
  if (lınk.some(word => msg.content.toLowerCase().includes(word)) ) {
    if (!msg.member.hasPermission("ADMINISTRATOR")) {
      msg.delete()
       msg.reply("Bu sunucuda Reklamlar **REGO CRAFT** tarafından engellenmektedir! Reklam yapmana izin vermeyeceğim!").then(message => message.delete(3000));
    }
}
    }
});
